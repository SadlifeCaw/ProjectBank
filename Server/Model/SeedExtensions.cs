...
public static class SeedExtensions
{
    ...
    private static async Task SeedProjectsAsync(ProjectBankContext context)
    {
        ...
        if (!await context.Projects.AnyAsync())
        {
            ...
            var PR_2 = new Project(SP_1, "Programmeringshoest or how to teach Programming","Welcome to the great ProgrammeringsHoest project, where you will be forced to solve difficult programming exercises every day",ProjectStatus.PUBLIC,Faculty_COMPSCI_ITU,new List<Tag>(){HEURISTIC, JAVA, ALGORITHM}, new List<User>(){ST_4,ST_2,ST_8, SP_1}, new List<ProjectBucket>(),11);
            var PR_3 = new Project(SP_3, "Ancient Greece and Eros", "This thesis would focus on how the ancient Greeks saw love, eros, and which different interpretations existed during the time of Platon", ProjectStatus.PRIVATE, Faculty_HIS_KU, new List<Tag>() {LIT, GREECE, PHIL}, new List<User>() {ST_6, ST_7}, new List<ProjectBucket>(), 5);
