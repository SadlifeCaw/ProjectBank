...
public static class SeedExtensions
{
    ...
    private static async Task SeedProjectsAsync(ProjectBankContext context)
    {
        ...
        if (!await context.Projects.AnyAsync())
        {
            ...
            //Projects
            var PR_1 = new Project(SP_1, "FirstYearProject_Map of DK", "Imagine google maps, but using more RAM than the servers of google combined",ProjectStatus.PUBLIC,Faculty_COMPSCI_ITU, new List<Tag>(){JAVA,ALGORITHM}, new List<User>() {ST_1, ST_7, ST_2}, new List<ProjectBucket>(),20);
            var PR_2 = new Project(SP_1, "ProgrammeringsHoest","Welcome to the great ProgrammeringsHoest project, where you will be forced to solve difficult programming exercises every day",ProjectStatus.PUBLIC,Faculty_COMPSCI_ITU,new List<Tag>(){HEURISTIC, JAVA, ALGORITHM}, new List<User>(){ST_4,ST_2,ST_8}, new List<ProjectBucket>(),11);
