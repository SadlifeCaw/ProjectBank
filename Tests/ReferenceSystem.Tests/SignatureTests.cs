...
using Xunit;
using ProjectBank.Infrastructure.Entities.ReferenceSystem;
...
namespace ReferenceSystem.Tests
{
    ...
    public class SignatureTests
    {
        ...
        static string expectedAgricultureSimpleHash = "agriculture".GetHashCode().ToString();
        static List<string> expectedAgriculture = new List<string> { expectedAgricultureSHA1, expectedAgricultureSHA256, expectedAgricultureMD5, expectedAgricultureSHA384, expectedAgricultureSHA512, expectedAgricultureSimpleHash };
        ...
        static string expectedComputerScienceSimpleHash = "computer science".GetHashCode().ToString();

        static List<string> expectedAgricultureComputerScience = new List<string> { expectedComputerScienceSHA1, expectedComputerScienceSHA256, expectedComputerScienceMD5, expectedComputerScienceSHA384, expectedAgricultureSHA512, expectedComputerScienceSimpleHash };
